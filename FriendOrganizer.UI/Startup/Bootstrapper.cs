...
namespace FriendOrganizer.UI.Startup
{
    public class Bootstrapper
    {
        public IContainer Bootstrap()
        {
            ...
            builder.RegisterType<LocationDataAccessPoint>().As<ILocationDataAccessPoint>();
            builder.RegisterType<LocationRepostitory>().As<ILocationRepostitory>();
            builder.RegisterType<LocationService>().As<ILocationService>();
            builder.RegisterType<WeatherDataAccessPoint>().As<IWeatherDataAccessPoint>();
